        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WalletsId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOnUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    ModifiedOnUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    CourtGroupId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookMark_ApplicationUser_UserId1",
                        column: x => x.UserId1,
                        principalTable: "ApplicationUser",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOnUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    ModifiedOnUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    CourtYardId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOnUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    ModifiedOnUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    WardId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CourtGroup_Ward_WardId1",
                        column: x => x.WardId1,
                        principalTable: "Ward",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CourtYard_CourtGroup_CourtGroupId1",
                        column: x => x.CourtGroupId1,
                        principalTable: "CourtGroup",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Media_ApplicationUser_UserId1",
                        column: x => x.UserId1,
                        principalTable: "ApplicationUser",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Media_CourtGroup_CourtGroupId1",
                        column: x => x.CourtGroupId1,
                        principalTable: "CourtGroup",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Wallet_CourtGroup_CourtGroupId",
                        column: x => x.CourtGroupId,
                        principalTable: "CourtGroup",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Slot_CourtYard_CourtYardId1",
                        column: x => x.CourtYardId1,
                        principalTable: "CourtYard",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deposit_ApplicationUser_UserId1",
                        column: x => x.UserId1,
                        principalTable: "ApplicationUser",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deposit_Wallet_WalletId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SlotBooking_Booking_BookingId1",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SlotBooking_Slot_SlotId1",
                        column: x => x.SlotId1,
                        principalTable: "Slot",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transaction_ApplicationUser_UserId1",
                        column: x => x.UserId1,
                        principalTable: "ApplicationUser",
                        principalColumn: "Id");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transaction_Wallet_WalletId1",
                        column: x => x.WalletId1,
                        principalTable: "Wallet",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUser_WalletsId",
                table: "ApplicationUser",
                column: "WalletsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Booking_CourtGroupId1",
                table: "Booking",
                column: "CourtGroupId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookMark_CourtGroupId1",
                table: "BookMark",
                column: "CourtGroupId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourtYard_CourtGroupId1",
                table: "CourtYard",
                column: "CourtGroupId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SlotBooking_BookingId1",
                table: "SlotBooking",
                column: "BookingId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transaction_WalletId1",
                table: "Transaction",
                column: "WalletId1");

            migrationBuilder.CreateIndex(
                name: "IX_Wallet_CourtGroupId",
                table: "Wallet",
                column: "CourtGroupId",
                unique: true);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ApplicationUser_Wallet_WalletsId",
                table: "ApplicationUser",
                column: "WalletsId",
                principalTable: "Wallet",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Booking_CourtGroup_CourtGroupId1",
                table: "Booking",
                column: "CourtGroupId1",
                principalTable: "CourtGroup",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_BookMark_CourtGroup_CourtGroupId1",
                table: "BookMark",
                column: "CourtGroupId1",
                principalTable: "CourtGroup",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Cost_CourtYard_CourtYardId1",
                table: "Cost",
                column: "CourtYardId1",
                principalTable: "CourtYard",
                principalColumn: "Id");
