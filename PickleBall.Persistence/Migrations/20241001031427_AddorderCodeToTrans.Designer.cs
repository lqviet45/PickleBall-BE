...
namespace PickleBall.Persistence.migrations
{
    ...
    [Migration("20241001031427_AddorderCodeToTrans")]
    partial class AddorderCodeToTrans
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PickleBall.Domain.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PickleBall.Domain.Entities.TransactionProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PickleBall.Domain.Entities.TransactionProduct", b =>
                {
                    b.HasOne("PickleBall.Domain.Entities.Product", "Product")
                        .WithMany("TransactionProducts")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("PickleBall.Domain.Entities.Transaction", "Transaction")
                        .WithMany("TransactionProducts")
