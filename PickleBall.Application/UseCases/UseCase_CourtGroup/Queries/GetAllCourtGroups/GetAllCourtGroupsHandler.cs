...
{
    public class GetAllCourtGroupsHandler(IUnitOfWork unitOfWork)
        : IRequestHandler<GetAllCourtGroupsQuery, Result<IEnumerable<CourtGroup>>>
    {
        private readonly IUnitOfWork _unitOfWork = unitOfWork;
        public async Task<Result<IEnumerable<CourtGroup>>> Handle(GetAllCourtGroupsQuery request, CancellationToken cancellationToken)
        {
