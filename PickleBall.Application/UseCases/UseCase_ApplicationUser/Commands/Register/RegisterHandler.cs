...
internal sealed class RegisterHandler(
    ...
    RoleManager<ApplicationRole> roleManager) : IRequestHandler<RegisterCommand, Result<ApplicationUserDto>>
{
    ...
    private async Task AddUserToDB(ApplicationUserDto userDto, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            if (!await _roleManager.RoleExistsAsync(userDto.Role.ToString()))
            {
                var roleAdded = await _roleManager.CreateAsync(new ApplicationRole()
                {
